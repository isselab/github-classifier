...
class TestATEConv(unittest.TestCase):
    ...
    def test_call_external_library_class(self):
        ...
        self.assertEqual(ecore_graph.modules[1].location, 'data', 'imported module from external library has wrong name')
        self.assertEqual(len(ecore_graph.modules[1].contains), 2, 'wrog number of imported methods/classes')
        self.assertEqual(ecore_graph.modules[1].contains[0].signature.method.tName, 'Dataset', 'method wrong name')
